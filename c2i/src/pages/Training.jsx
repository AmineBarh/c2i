...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize the filtered array to prevent O(N) filtering operations on every render
  ...
  // Calculate stats
  // ⚡ Bolt: Memoize the static stats array to prevent recreation on every render
  const stats = useMemo(() => {
    return [
      {
