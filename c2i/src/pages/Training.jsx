...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filtered trainings to prevent recalculation on unrelated re-renders (like form input).
  ...
  // ⚡ Bolt: Memoize static stats to avoid recreating the array on every render.
  const stats = useMemo(() => {
    return [
      {
