...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filteredTrainings to prevent O(N) array filtering and reallocation on unrelated re-renders (like opening a modal or updating form state)
  ...
  // ⚡ Bolt: Memoize static stats array to prevent recreation on every render
  const stats = useMemo(() => [
    {
