...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filteredTrainings to prevent O(N) filtering on every render.
  ...
  // ⚡ Bolt: Memoize stats to prevent recreating the array and elements on every render.
  const stats = useMemo(() => {
    return [
      {
