...
const Training = () => {
  ...
  // ⚡ Bolt: Memoized the derived filtered trainings array and static stats array to prevent O(N) array filtering and object recreation on unrelated re-renders.
