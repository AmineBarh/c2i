...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filtered trainings to prevent O(N) recalculations on unrelated renders
  ...
  // Calculate stats
  // ⚡ Bolt: Memoize stats array definition to prevent recreating it on every render
  const stats = useMemo(() => {
    return [
      {
