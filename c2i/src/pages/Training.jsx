...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filtered trainings to prevent redundant filtering when unrelated form state changes
  ...
  // ⚡ Bolt: Memoize stats to avoid recreating static objects on every render
  const stats = useMemo(() => {
    return [
      {
