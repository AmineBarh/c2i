...
const Training = () => {
  ...
  // ⚡ Bolt: Memoize filtered trainings to prevent O(N) recalculations on every render
  ...
  // ⚡ Bolt: Memoize static stats to prevent unnecessary array creation on every render
  const stats = useMemo(() => [
    {
  ...
  // ⚡ Bolt: Memoize static features array to prevent unnecessary recreation
