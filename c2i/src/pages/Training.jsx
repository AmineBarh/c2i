...
const Training = () => {
  ...
  // ⚡ Bolt: Memoized filteredTrainings to prevent O(N) array filtering on unrelated component updates
  ...
  // Calculate stats
  // ⚡ Bolt: Memoized static stats array to prevent recreation on every render
  const stats = useMemo(() => {
    return [
      {
