...
const Admin = () => {
  ...
  // ⚡ Bolt: Consolidated O(N) filtering and counting of projects using useMemo.
  // This prevents multiple sequential array traversals on every render, especially when searchTerm changes.
  const { filteredProjects, totalProjects, iotProjects, webProjects, automationProjects } = useMemo(() => {
    ...
    for (let i = 0; i < projects.length; i++) {
      ...
      else if (p.type === "automation") auto++;
    ...
    return { filteredProjects: filtered, totalProjects: projects.length, iotProjects: iot, webProjects: web, automationProjects: auto };
