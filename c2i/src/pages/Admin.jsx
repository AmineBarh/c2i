...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to prevent O(N) recalculations on unrelated state changes
  ...
  // ⚡ Bolt: Combine multiple O(N) project type counts into a single O(N) reduce pass
