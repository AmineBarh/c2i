...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to avoid O(N) re-calculation on unrelated renders (e.g., toggling sidebar)
  ...
  // ⚡ Bolt: Combine multiple O(N) passes into a single pass and memoize the result
