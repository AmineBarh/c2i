...
const Admin = () => {
  ...
  // ⚡ Bolt: Optimize filteredProjects by memoizing to prevent O(N) recalculation on unrelated re-renders (e.g. sidebar open/close). Also hoisted searchTerm.toLowerCase() outside the filter loop.
  ...
  // ⚡ Bolt: Combine multiple O(N) filters into a single O(N) pass to calculate categorical project counts.
