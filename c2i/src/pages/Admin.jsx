...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) array filtering and string manipulation
  // from running on every unrelated state change (e.g. typing in inputs).
  ...
  // ⚡ Bolt: Combine multiple O(N) filter loops into a single O(N) reduce operation
  // and memoize the result to calculate counts efficiently.
