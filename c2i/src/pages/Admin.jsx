...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoized filtering to avoid redundant O(N) string and array ops during unrelated renders (e.g., sidebar toggling).
  ...
  // ⚡ Bolt: Combined 3 sequential O(N) filters into a single O(N) loop and memoized to avoid recalculation
