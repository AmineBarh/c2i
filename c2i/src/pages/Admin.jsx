...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations on unrelated state changes (like activeSection)
  ...
  // ⚡ Bolt: Combine multiple O(N) filters into a single O(N) reduce pass and memoize it
