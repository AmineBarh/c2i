...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations during unrelated renders (e.g., sidebar toggling)
  ...
  // ⚡ Bolt: Memoize project counts to prevent multiple O(N) passes on every render
