...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) filtering on every render when unrelated states (like sidebar open/close) change
  ...
  // ⚡ Bolt: Consolidate multiple O(N) array loops (.filter().length) into a single O(N) loop and memoize
