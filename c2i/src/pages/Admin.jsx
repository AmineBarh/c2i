...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to avoid O(N) filtering and string manipulation on every render (e.g., when sidebar opens/closes).
  ...
  // ⚡ Bolt: Combine multiple O(N) filtering passes into a single O(N) pass using useMemo and reduce for better performance.
