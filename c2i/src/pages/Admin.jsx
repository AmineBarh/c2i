...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) filtering on unrelated state changes (like sidebar toggles)
  ...
  // ⚡ Bolt: Consolidate multiple O(N) array passes into a single O(N) loop with useMemo
