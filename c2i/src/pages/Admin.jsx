...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to avoid O(N) filtering on every render unless dependencies change
  ...
  // ⚡ Bolt: Consolidate multiple O(N) filter passes for category counts into a single O(N) memoized reduce
