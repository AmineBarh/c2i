...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoized project filtering to avoid expensive O(N) re-evaluations during text input.
  ...
  // ⚡ Bolt: Consolidated category counts into a single O(N) loop and memoized to prevent recalculating on every render.
