...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculation on unrelated re-renders (e.g. sidebar toggles)
  ...
  // ⚡ Bolt: Combine 3 O(N) filter passes into a single O(N) reduce loop and memoize
