...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoized derived states and combined multiple O(N) array passes into a single reduce pass. This prevents expensive string matching and array traversals on every render, especially when typing in the search bar.
