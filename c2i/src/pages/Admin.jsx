...
const Admin = () => {
  ...
  const filteredProjects = useMemo(() => {
    // ⚡ Bolt: Memoized derived state to prevent recalculation on unrelated renders (like toggling sidebar)
  ...
  const { totalProjects, iotProjects, webProjects, automationProjects } = useMemo(() => {
    // ⚡ Bolt: Consolidated multiple O(N) filters into a single O(N) reduce pass and memoized
