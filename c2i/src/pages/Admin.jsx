...
const Admin = () => {
  ...
  // ⚡ Bolt: Consolidated multiple O(N) filter/length passes into a single O(N) pass using useMemo.
  // This prevents recalculating these derived arrays and counts on every component re-render.
  const {
    filteredProjects,
    totalProjects,
    iotProjects,
