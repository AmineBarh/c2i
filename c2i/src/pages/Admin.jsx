...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) array filtering on every render
  ...
  // ⚡ Bolt: Calculate project counts in a single O(N) pass using useMemo instead of multiple sequential O(N) filters
