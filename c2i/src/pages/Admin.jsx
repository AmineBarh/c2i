...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations on unrelated state changes
  ...
  // ⚡ Bolt: Consolidate multiple O(N) filter passes into a single O(N) reduce pass and memoize it
