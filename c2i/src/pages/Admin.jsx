...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) re-filtering on unrelated re-renders (e.g. toggling sidebar)
  ...
  // ⚡ Bolt: Memoize project counts to prevent multiple O(N) iterations on unrelated re-renders
