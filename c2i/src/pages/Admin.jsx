...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoized filtered projects to prevent O(N) recalculation on unrelated re-renders (e.g. activeSection change)
  ...
  // ⚡ Bolt: Consolidated 3 separate O(N) filter passes into a single O(N) reduce pass, memoized by projects
