...
const Admin = () => {
  ...
  // ⚡ Bolt: Replaced multiple O(N) array filters with a single O(N) pass using useMemo.
  // This concurrently calculates counts and filters projects, preventing redundant recalculations during unrelated state updates.
  const {
    filteredProjects,
    totalProjects,
    iotProjects,
    ...
    projects.forEach((p) => {
      ...
      // Filter based on search and categories
      if (
