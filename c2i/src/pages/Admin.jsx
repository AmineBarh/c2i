...
const Admin = () => {
  ...
  // ⚡ Bolt: Consolidated 4 O(N) array iterations into a single O(N) pass and wrapped in useMemo
  // to prevent re-computation when unrelated state (like sidebarOpen or activeSection) changes.
