...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) filtering on unrelated re-renders
  ...
  // ⚡ Bolt: Combine multiple O(N) array passes into a single O(N) pass for category counts
