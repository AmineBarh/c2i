...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to prevent O(N) array filtering and string operations on unrelated state changes (like sidebar toggles).
  ...
  // ⚡ Bolt: Consolidate three O(N) filter passes into a single O(N) reduce pass and memoize the result.
