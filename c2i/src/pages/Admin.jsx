...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations on every render, especially during fast typing in search.
  ...
  // ⚡ Bolt: Calculate all project counts in a single O(N) pass and memoize to avoid 3 separate filter passes on every render.
