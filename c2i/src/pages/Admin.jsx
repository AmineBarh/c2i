...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoized derived state and combined categorical counts into a single O(N) reduce pass
  // to prevent unnecessary re-computations (e.g. during sidebar toggles).
