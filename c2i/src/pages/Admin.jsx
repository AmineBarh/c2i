...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations on unrelated re-renders (like sidebar toggle) or on every keystroke in input.
  ...
  // ⚡ Bolt: Memoize expensive stats calculations to avoid O(N) loops on every render.
