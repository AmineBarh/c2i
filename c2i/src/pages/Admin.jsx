...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to avoid O(N) recalculation on every render, especially crucial when typing in high-frequency search inputs.
  ...
  // ⚡ Bolt: Consolidate multiple sequential O(N) filter passes into a single O(N) reduce loop to compute categorical project counts, memoized to only run when projects change.
