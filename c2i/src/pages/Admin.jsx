...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculation on unrelated state changes (like sidebar toggle)
  ...
  // ⚡ Bolt: Combine multiple O(N) filter passes into a single O(N) reduce pass and memoize it
