...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent unnecessary O(N) re-computations on every render/keystroke
  ...
  // ⚡ Bolt: Combine multiple O(N) filter passes into a single O(N) loop to optimize categorical project counts
