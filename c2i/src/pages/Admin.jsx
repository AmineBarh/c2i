...
const Admin = () => {
  ...
  // ⚡ Bolt: Wrap filteredProjects in useMemo to prevent O(N) filter operation on unrelated re-renders (like sidebar toggles)
  ...
  // ⚡ Bolt: Combine multiple O(N) passes into a single pass using useMemo
