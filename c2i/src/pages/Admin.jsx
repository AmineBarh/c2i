...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculation on every re-render (e.g. typing in search)
  ...
  // ⚡ Bolt: Replace multiple O(N) .filter() passes with a single O(N) loop
