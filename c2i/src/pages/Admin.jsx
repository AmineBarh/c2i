...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent O(N) recalculations on unrelated state changes (like sidebar toggle)
  ...
  // ⚡ Bolt: Consolidate multiple O(N) `.filter().length` passes into a single O(N) pass via `reduce`
