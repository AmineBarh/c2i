...
const Admin = () => {
  ...
  // ⚡ Bolt: Replaced multiple O(N) array .filter() operations on every render
  // with a single O(N) loop memoized by search inputs and projects.
  const { filteredProjects, totalProjects, iotProjects, webProjects, automationProjects } = useMemo(() => {
    ...
    projects.forEach((project) => {
      // Calculate category counts for all projects
