...
const Admin = () => {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent expensive string comparisons on every render
  ...
  // ⚡ Bolt: Combine multiple O(N) array filter passes into a single O(N) reduce pass and memoize it
