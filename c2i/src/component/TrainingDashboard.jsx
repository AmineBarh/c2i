...
const TrainingDashboard = ({ trainings = [], handleCreateTraining, handleUpdateTraining, handleDeleteTraining }) => {
  ...
  // ⚡ Bolt: Memoize filteredTrainings to avoid array allocation on every render
  ...
  // ⚡ Bolt: Memoize stats to avoid recreating multiple Sets over arrays on every render
  const stats = useMemo(() => [
    {
