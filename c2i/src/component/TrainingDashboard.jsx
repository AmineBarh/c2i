...
const TrainingDashboard = ({ trainings = [], handleCreateTraining, handleUpdateTraining, handleDeleteTraining }) => {
  ...
  // ⚡ Bolt: Memoize filteredTrainings to prevent O(N) array filtering and string manipulations on every render
  ...
  // ⚡ Bolt: Memoize stats calculation to prevent creating new Set instances and running O(N) maps on every render
  const stats = useMemo(() => [
    {
