...
const Summary = ({
  ...
  // ⚡ Bolt: Memoize derived displayProjects to prevent redundant re-evaluations during unrelated state updates.
  ...
  // ⚡ Bolt: Memoize categories generation to prevent expensive O(N) mapping and Set creation on every render.
