...
const Summary = ({
  ...
  // ⚡ Bolt: Memoize derived state to prevent redundant array checks and allocations on every render
  ...
  // ⚡ Bolt: Memoize categories calculation to prevent O(N) map/filter operations and Set instantiations on every render
