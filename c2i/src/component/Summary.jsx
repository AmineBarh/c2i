...
const Summary = ({
  ...
  // ⚡ Bolt: Memoized displayProjects to prevent redundant array checks on every render
  ...
  // ⚡ Bolt: Memoized categories to prevent expensive O(N) Set generation on every render
