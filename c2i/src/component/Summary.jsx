...
const Summary = ({
  ...
  // ⚡ Bolt: Memoize derived displayProjects to prevent redundant re-evaluations
  ...
  // ⚡ Bolt: Memoize categories generation (O(N) operation) to avoid unnecessary recalculation on every render
