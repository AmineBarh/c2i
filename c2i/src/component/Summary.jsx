...
const Summary = ({
  ...
  // ⚡ Bolt: Memoized displayProjects to prevent redundant array checks and assignments on every render
  ...
  // ⚡ Bolt: Memoized categories to prevent O(N) array mapping and Set creation on every render
