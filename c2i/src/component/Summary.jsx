...
const Summary = ({
  ...
  // ⚡ Bolt: Memoize the array of projects to display to prevent redundant array checks
  ...
  // ⚡ Bolt: Memoize categories to prevent O(N) Set generation on every render (especially when typing in search)
